...
void demo_cu(int packet_num)
{
    ...
    auto sf_cu = new CUSketchWithSF<meminkb * 1024, percent>((meminkb * 1024*0.01*percent / (8 * 8)) * 0.99, (meminkb * 1024*0.01*percent  / (8 * 8)) * 0.01,
                                          8, 32, 32,
                                          thres1, thres2,
                                          750, 800);
...
int main(){
    ...
    demo_cu<(int)(1024 * 0.1)>(packet_num);
    demo_cu<(int)(1024 * 0.2)>(packet_num);
    demo_cu<(int)(1024 * 0.3)>(packet_num);
    demo_cu<(int)(1024 * 0.4)>(packet_num);
    demo_cu<(int)(1024 * 0.5)>(packet_num);
    demo_cu<(int)(1024 * 0.6)>(packet_num);
    demo_cu<(int)(1024 * 0.7)>(packet_num);
    demo_cu<(int)(1024 * 0.8)>(packet_num);
    demo_cu<(int)(1024 * 0.9)>(packet_num);
    demo_cu<(int)(1024 * 1.0)>(packet_num);
